...
# SDMX 2.0 support by Claudio Fahey <claudiofahey@gmail.com>


'''
This module contains a reader for SDMXML v2.0.
...
class Reader(BaseReader):
    ...
    """
    Read SDMX-ML 2.0 and expose it as instances from pandasdmx.model
    """
    ...
    _nsmap = {
        ...
        'gen':    'http://www.SDMX.org/resources/SDMXML/schemas/v2_0/generic',
        'footer': 'http://www.sdmx.org/resources/SDMXML/schemas/v2_0/message/footer'
    }
    ...
    def initialize(self, source):
        ...
        elif root.tag.endswith('MessageGroup'):
    ...
    def normalize_message(self):
        '''
        Fix up message to make it look like SDMX 2.1.
        '''
        self.message.header.dim_at_obs = 'TIME_PERIOD'
    ...
    _paths = {
        ...
        'series_key_id_path': 'gen:SeriesKey/gen:Value/@concept',
        'generic_series_dim_path': 'gen:Time/text()',
        ...
        'attr_id_path': 'gen:Attributes/gen:Value/@concept',
    ...
    def iter_generic_series_obs(self, sdmxobj, with_value, with_attributes,
        ...
        for obs in sdmxobj._elem.iterchildren(
                '{http://www.SDMX.org/resources/SDMXML/schemas/v2_0/generic}Obs',
